...
1. Trattare gli NA
2. Usare la regressione lasso per scoprire le variabili più importanti nei "gruppi" di variabili correlate
3. Testare i modelli sotto riportati
4. Fare una media dei prezzi risultati dalle medie in questione 
